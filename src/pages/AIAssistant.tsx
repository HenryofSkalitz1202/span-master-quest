...
const AIAssistant = () => {
  ...
  const [conversation, setConversation] = useState<Array<{
  ...
  }>>([
    {
      id: 1,
      sender: 'ai',
      message: 'Halo! Saya Matea, asisten AI Anda. Saya siap membantu menjelaskan materi pembelajaran. Apa yang ingin Anda pelajari hari ini?',
      timestamp: new Date()
    }
  ]);
  ...
  const voices = [
    ...
    { id: "charlie", name: "Charlie", description: "Suara pria yang hangat" }
  ];

  const avatars = [
    { id: "teacher", name: "Guru Matea", image: "/api/placeholder/64/64", description: "Avatar guru yang berpengalaman" },
    { id: "student", name: "Teman Belajar", image: "/api/placeholder/64/64", description: "Avatar teman sebaya" },
    { id: "professor", name: "Profesor", image: "/api/placeholder/64/64", description: "Avatar akademisi senior" },
    { id: "tutor", name: "Tutor Pribadi", image: "/api/placeholder/64/64", description: "Avatar tutor personal" }
  ];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg">
            Belajar dengan bantuan AI yang dapat berbicara dan menjelaskan
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Pengaturan Avatar</CardTitle>
              </CardHeader>
